"""FOR USE WITH STATES AND APIS. MUST UPDATE REFLEX VARS: SPAN, LINK_BOX, 
LINK_OVERLAY, FUNCTIONS RENDER_TOPICS AND RENDER_PROJECTS_CARDS AND IS_PROCESSING,
IS_FINISHED, CIRCULAR_PROGRESS, GET_REPOSITORIES"""
