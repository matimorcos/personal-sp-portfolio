...
project_about: Dict[str, str] = {
    "ichiel-software-venture-ums": "Local storage application with NextJS and FastAPI involves utilizing both frameworks to handle client-side and server-side functionalities, respectively.",
    "": "Local storage application with NextJS and FastAPI involves utilizing both frameworks to handle client-side and server-side functionalities, respectively.",
    "": "Local storage application with NextJS and FastAPI involves utilizing both frameworks to handle client-side and server-side functionalities, respectively.",
    "": "Local storage application with NextJS and FastAPI involves utilizing both frameworks to handle client-side and server-side functionalities, respectively.",
    "": "Local storage application with NextJS and FastAPI involves utilizing both frameworks to handle client-side and server-side functionalities, respectively."
}
